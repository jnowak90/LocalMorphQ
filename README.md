...
To replicate the data provided in the study, first download the data from [Zenodo](10.5281/zenodo.20138600). Unzip the DataPCs folder and copy into the data/ folder of LocalMorphQ. Copy the config files (<em>config_Cotyledons.yaml</em>, <em>config_Leaves.yaml</em>) into the config/ folder of LocalMorphQ.
