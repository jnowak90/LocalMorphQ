...
def main():
    ...
    for gt in cells.keys():
        ...
        for idx, tp in enumerate(cells[gt].keys()):
            if gt == 'WT':
                ...
                name = 'Figure6A_Leaves_ComplexityHeatmap_WT.png'
            else:
                resolution = 1 / 6.5445
                name = 'Figure6B_Leaves_ComplexityHeatmap_Mutant.png'
    ...
    fig.savefig(pathPlots / 'Figure6C_Leaves_ShapeComplexityDistributions_WT_Mutant.png', bbox_inches='tight', dpi=300)               
    plt.close()
    ...
    fig.savefig(pathPlots / 'Figure6D_Leaves_ShapeComplexityLobes_WT_Mutant.png', bbox_inches='tight', dpi=300)               
    plt.close()
    ...
    plt.legend()
    fig.savefig(pathPlots / 'Figure6E_Leaves_ShapeComplexityArea_WT_Mutant.png', bbox_inches='tight', dpi=300)               
    plt.close()    
